// import homeIcon from "../assets/allimg/Background (1).svg";
// import HealthcareIcon from "../assets/allimg/Background (2).svg";
              ...
              <div className="py-[40px] lg:py-[112px] ">
                ...
                <div className="h-[200px] md:h-[300px] xl:h-[500px] py-[20px] md:py-[50px] xl:py-[100px]">
                  <div className=" relative  w-[100vw]">
                    <div className="-rotate-[7.1deg] absolute left-1/2 -translate-x-[44vw] 2xl:-translate-x-[670px] 2xl:top-[30px] top-[10px] md:top-[30px] w-[33vw]  2xl:w-[500px]">
                      <img
                        src={cadeIcon1}
                        alt="cadeIcon1"
                    ...
                    <div className="rotate-[5.32deg] absolute left-1/2 top-0 -translate-x-1/2 z-10 w-[33vw] 2xl:w-[500px]">
                      <img
                        src={cadeIcon2}
                        alt="cadeIcon1"
                        className="object-fill w-full"
                    ...
                    <div className="rotate-[-11.13deg] absolute left-1/2 translate-x-[12vw] 2xl:translate-x-[200px] top-0 w-[33vw] 2xl:w-[500px]">
                      <img
                        src={cadeIcon3}
                        alt="cadeIcon1"
                        className="object-fill  w-full"
                    ...
                    <div className="absolute left-1/2 top-[-5vw] 2xl:top-[-50px] translate-x-[5vw]  w-[15vw] 2xl:w-[230px] ">
                      <img
                        src={arrow2}
                        alt="arrow2"
                        className="object-fill w-full"
