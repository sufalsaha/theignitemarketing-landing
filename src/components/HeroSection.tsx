...
import whatappIcon from "../assets/allimg/image 76.svg";
import Backgroundimg1 from "../assets/allimg/Background+Shadow (2).png";
import Backgroundimg2 from "../assets/allimg/image 850 (1).png";
import Backgroundimg3 from "../assets/allimg/image 851.svg";
import Backgroundimg4 from "../assets/allimg/Background+Shadow (1).jpg";
import Backgroundimg5 from "../assets/allimg/business-consultant-side-1 (1).png";
import Backgroundimg6 from "../assets/allimg/Background+Shadow (2).png";
      ...
      const st = ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (upboxRef.current) {
            ...
            const opacityadd = self.progress;
            setOpacity(opacityadd);
            // console.log("hello" + opacityadd);
                  ...
                  <div className="w-full h-full">
                    <div className="relative w-full  ">
                      <div
                        ref={upboxRef}
                        className={clsx(
                          "w-full flex flex-col justify-center items-center absolute md:top-[30px] lg:top-[130px] ",
                          {
                            " z-0": !(opacity < 0.1),
                            " z-10": opacity < 0.1,
                          }
